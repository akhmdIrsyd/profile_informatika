                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="scopus" name="scopus" value="{{ old('scopus') }}" placeholder="Masukkan URL Scopus">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="sinta">Sinta</label>
                            <input type="text" class="form-control" id="sinta" name="sinta" value="{{ old('sinta') }}" placeholder="Masukkan URL Sinta">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="gscholar">Google Scholar</label>
                            <input type="text" class="form-control" id="gscholar" name="gscholar" value="{{ old('gscholar') }}" placeholder="Masukkan URL Google Scholar">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="s1" name="s1" value="{{ old('s1') }}" placeholder="Masukkan Informasi S1">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="s2">S2</label>
                            <input type="text" class="form-control" id="s2" name="s2" value="{{ old('s2') }}" placeholder="Masukkan Informasi S2">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="s3">S3</label>
                            <input type="text" class="form-control" id="s3" name="s3" value="{{ old('s3') }}" placeholder="Masukkan Informasi S3">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="minat" name="minat" value="{{ old('minat') }}" placeholder="Masukkan Informasi minat">
                        </div>
                    </div>
                </div>
