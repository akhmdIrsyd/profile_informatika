...
class Tipe_berkasController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = Tipe_berkas::select(['id', 'nama']);
            ...
            return view('admin.tipe_berkas.index');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $request->validate([
                'itemId' => 'nullable|integer|exists:tipe_berkas,id',
            ...
            $item = Tipe_berkas::updateOrCreate(
                    ['id' => $request->itemId],
                    [
                        'nama' => $request->nama,
                    ]
    ...
    public function destroy(string $id)
    {
        //
        try {
            $dosen = Tipe_berkas::findOrFail($id);
            $dosen->delete();
